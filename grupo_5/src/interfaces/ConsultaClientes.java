...
public class ConsultaClientes extends javax.swing.JInternalFrame {
    ...
    public ConsultaClientes() {
        initComponents();
        jList1.setModel(ListaClientes.getLista());
    }
    ...
    private void jbExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbExcluirActionPerformed
        try {System.out.println("Excluindo cliente: " + jList1.getSelectedIndex());
        ListaClientes.remover(jList1.getSelectedIndex());
        Mensagem.informacao("Cliente Excluído", "Exclusão de Cadastro");
        jList1.updateUI();
        }catch (Exception e){
