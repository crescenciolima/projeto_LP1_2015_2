 ...
 * @author mp012
 */
public class ConsultaVendedores extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jList1.setModel(ListaVendedores.getLista());
    ...
    private void jbExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbExcluirActionPerformed
        try{System.out.println("Excluindo Vendedor: " + jList1.getSelectedIndex());
        ListaVendedores.remover(jList1.getSelectedIndex());
        Mensagem.informacao("Vendedor Excluído", "Exclusão de Cadastro");
        jList1.updateUI();
        }catch (Exception e){
